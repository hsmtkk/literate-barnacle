...
func (x *NewBooking) GetStartDateTime() string {
	if x != nil {
...
func (x *Booking) GetStartDateTime() string {
	if x != nil {
		return x.StartDateTime
	}
	return ""
...
var file_proto_booking_booking_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x65, 0x6e, 0x64, 0x44, 0x61,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x65, 0x6e, 0x64, 0x44, 0x61, 0x74, 0x65, 0x54,
