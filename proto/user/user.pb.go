...
func (x *DummyListResponse) GetUsers() []*User {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *CreateReqeust) GetUser() *NewUser {
	if x != nil {
		return x.User
	}
	return nil
...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x22, 0x32, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x65, 0x75, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x4e, 0x65, 0x77, 0x55, 0x73, 0x65,
	...
	0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x84, 0x01, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3e, 0x0a, 0x09, 0x44, 0x75, 0x6d,
	0x6d, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x16, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44, 0x75,
	0x6d, 0x6d, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44, 0x75, 0x6d, 0x6d, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x52,
	...
	0x65, 0x52, 0x65, 0x71, 0x65, 0x75, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	...
	0x61, 0x72, 0x6e, 0x61, 0x63, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x73,
...
var file_proto_user_user_proto_goTypes = []interface{}{
	...
	(*DummyListRequest)(nil),  // 2: user.DummyListRequest
	(*DummyListResponse)(nil), // 3: user.DummyListResponse
	(*CreateReqeust)(nil),     // 4: user.CreateReqeust
	(*CreateResponse)(nil),    // 5: user.CreateResponse
}
var file_proto_user_user_proto_depIdxs = []int32{
	1, // 0: user.DummyListResponse.users:type_name -> user.User
	0, // 1: user.CreateReqeust.user:type_name -> user.NewUser
	1, // 2: user.CreateResponse.user:type_name -> user.User
	2, // 3: user.UserService.DummyList:input_type -> user.DummyListRequest
	4, // 4: user.UserService.Create:input_type -> user.CreateReqeust
	3, // 5: user.UserService.DummyList:output_type -> user.DummyListResponse
